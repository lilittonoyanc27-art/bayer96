...
const BANK_WORDS = [
  { es: 'aeropuerto', hy: 'օդանավակայան' },
  { es: 'traer', hy: 'բերել (այստեղ)' },
  { es: 'llevar', hy: 'տանել (այնտեղ)' },
  { es: 'agua', hy: 'ջուր' },
  { es: 'llamar', hy: 'զանգահարել' }
];
...
const DIALOG_LINES: DialogLine[] = [
  {
    id: 1,
    speaker: 'gor',
    textTemplate: '¡Hola, Gayane! Ya estoy en el {gap}.',
    gapId: 'aeropuerto',
    correctWord: 'aeropuerto',
    translationHy: 'Ողջույն, Գայանե՛: Ես արդեն օդանավակայանում եմ:',
  },
  {
    id: 2,
    speaker: 'gor',
    textTemplate: 'Por favor, ¿puedes {gap} mi pasaporte? Está en la mesa de casa.',
    gapId: 'traer',
    correctWord: 'traer',
    translationHy: 'Խնդրում եմ, կարո՞ղ ես բերել իմ անձնագիրը: Այն տան սեղանին է:',
  },
  {
    id: 3,
    speaker: 'gayane',
    textTemplate: 'Sí, claro. Voy a {gap} todo al aeropuerto ahora mismo.',
    gapId: 'llevar',
    correctWord: 'llevar',
    translationHy: 'Այո, իհարկե: Ես հենց հիմա ամեն ինչ կտանեմ օդանավակայան:',
  },
  {
    id: 4,
    speaker: 'gor',
    textTemplate: 'Muchas gracias. Y también necesito una botella de {gap} fría.',
    gapId: 'agua',
    correctWord: 'agua',
    translationHy: 'Շատ շնորհակալություն: Եվ նաև ինձ պետք է մի շիշ սառը ջուր:',
  },
  {
    id: 5,
    speaker: 'gayane',
    textTemplate: 'Perfecto. Te voy a {gap} cuando esté en la entrada.',
    gapId: 'llamar',
    correctWord: 'llamar',
    translationHy: 'Կատարյալ է: Ես քեզ կզանգահարեմ, երբ լինեմ մուտքի մոտ:',
  }
];

export default function Game4Dialogue({
  activePlayerName,
  onNextStage,
  awardPoints,
  activePlayerKey,
    ...
    <div className="max-w-4xl mx-auto px-4 py-6 font-sans">
      ...
      <div className="bg-white border-2 border-slate-200 rounded-2xl p-6 mb-8 shadow-sm text-base text-slate-700">
        <p className="font-display font-black text-slate-800 text-lg mb-2 uppercase tracking-wide">
          Գոռն արդեն օդանավակայանում է, իսկ Գայանեն դեռ տանն է: Նրանք խոսում են հեռախոսով:
        </p>
      ...
      <div className="flex justify-between items-center mt-8">
        ...
        {allGapsFilled && !showResults ? (
          ...
          >
            Անցնել Խաղ 5-ին <ArrowRight className="w-4 h-4" />
          </button>
        ) : null}
      </div>
    </div>
