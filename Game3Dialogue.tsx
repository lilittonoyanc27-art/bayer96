...
const DIALOG_LINES: DialogLine[] = [
  {
    id: 1,
    speaker: 'gor',
    textTemplate: '¡Gayane, por fin estamos en España! ¿Dónde está nuestro {gap}?',
    gapId: 'hotel',
    correctWord: 'hotel',
    translationHy: 'Գայանե, վերջապես մենք Իսպանիայում ենք: Որտե՞ղ է մեր հյուրանոցը:',
  },
  {
    id: 2,
    speaker: 'gayane',
    textTemplate: 'Está cerca de la {gap}. Me encanta escuchar el mar.',
    gapId: 'playa',
    correctWord: 'playa',
    translationHy: 'Այն լողափի մոտ է: Ես շատ եմ սիրում լսել ծովի ձայնը:',
  },
  {
    id: 3,
    speaker: 'gor',
    textTemplate: '¡Qué bien! Pero yo también quiero hacer una excursión a la {gap}.',
    gapId: 'montaña',
    correctWord: 'montaña',
    translationHy: 'Ինչ լավ է: Բայց ես նաև ցանկանում եմ էքսկուրսիա գնալ դեպի սարերը:',
  },
  {
    id: 4,
    speaker: 'gayane',
    textTemplate: 'Sí, claro. Pero primero entramos al hotel y pedimos la {gap} de la habitación.',
    gapId: 'llave',
    correctWord: 'llave',
    translationHy: 'Այո, իհարկե: Բայց սկզբում մտնենք հյուրանոց և խնդրենք սենյակի բանալին:',
  },
  {
    id: 5,
    speaker: 'gor',
    textTemplate: '¡Excelente! Y por la tarde daremos un paseo por la {gap}.',
    gapId: 'ciudad',
    correctWord: 'ciudad',
    translationHy: 'Գերազանց է: Իսկ երեկոյան կզբոսնենք քաղաքով:',
  }
];

export default function Game3Dialogue({
  activePlayerName,
  onNextStage,
  awardPoints,
  activePlayerKey,
    ...
    <div className="max-w-4xl mx-auto px-4 py-6 font-sans">
      ...
      <div className="bg-white border-2 border-slate-200 rounded-2xl p-6 mb-8 shadow-sm text-base text-slate-700">
        <p className="font-display font-black text-slate-800 text-lg mb-2 uppercase tracking-wide">
          Գոռն ու Գայանեն ժամանում են իրենց հյուրանոց և պլանավորում են զբոսանքները:
        </p>
      ...
      <div className="flex justify-between items-center mt-8">
        ...
        {allGapsFilled && !showResults ? (
          ...
          >
            Անցնել Խաղ 4-ին <ArrowRight className="w-4 h-4" />
          </button>
        ) : null}
      </div>
    </div>
