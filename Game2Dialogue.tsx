...
const BANK_WORDS = [
  { es: 'tiempo', hy: 'եղանակ' },
  { es: 'calor', hy: 'շոգ' },
  { es: 'baño', hy: 'լողազգեստ' },
  { es: 'solar', hy: 'արևապաշտպան քսուք' },
  { es: 'sol', hy: 'արև' }
];
...
const DIALOG_LINES: DialogLine[] = [
  {
    id: 1,
    speaker: 'gor',
    textTemplate: 'Gayane, ¿qué {gap} hace hoy en Barcelona?',
    gapId: 'tiempo',
    correctWord: 'tiempo',
    translationHy: 'Գայանե, ինչպիսի՞ եղանակ է այսօր Բարսելոնայում:',
  },
  {
    id: 2,
    speaker: 'gayane',
    textTemplate: 'Hace muy buen tiempo, ¡está soleado y hace mucho {gap}!',
    gapId: 'calor',
    correctWord: 'calor',
    translationHy: 'Շատ լավ եղանակ է, արևոտ է և շատ շոգ է:',
  },
  {
    id: 3,
    speaker: 'gor',
    textTemplate: '¡Qué bien! Entonces necesitamos ropa de {gap} para la playa.',
    gapId: 'baño',
    correctWord: 'baño',
    translationHy: 'Ինչ լավ է: Ուրեմն մեզ լողազգեստ է պետք լողափի համար:',
  },
  {
    id: 4,
    speaker: 'gayane',
    textTemplate: 'Sí, y también tenemos que usar el protector {gap}.',
    gapId: 'solar',
    correctWord: 'solar',
    translationHy: 'Այո, և նաև պետք է օգտագործենք արևապաշտպան քսուքը:',
  },
  {
    id: 5,
    speaker: 'gor',
    textTemplate: '¡Perfecto! El {gap} es excelente para nadar.',
    gapId: 'sol',
    correctWord: 'sol',
    translationHy: 'Կատարյալ է: Արևը հրաշալի է լողալու համար:',
  }
];

export default function Game2Dialogue({
  activePlayerName,
  onNextStage,
  awardPoints,
  activePlayerKey,
    ...
    <div className="max-w-4xl mx-auto px-4 py-6 font-sans">
      ...
      <div className="bg-white border-2 border-slate-200 rounded-2xl p-6 mb-8 shadow-sm text-base text-slate-700">
        <p className="font-display font-black text-slate-800 text-lg mb-2 uppercase tracking-wide">
          Գոռն ու Գայանեն ճշտում են Բարսելոնայի եղանակը և ընտրում համապատասխան հագուստը:
        </p>
      ...
      <div className="flex justify-between items-center mt-8">
        ...
        {allGapsFilled && !showResults ? (
          ...
          >
            Անցնել Խաղ 3-ին <ArrowRight className="w-4 h-4" />
          </button>
        ) : null}
      </div>
    </div>
